...
// Subclass automatically inherits @CustomAnnotation
class SubClass extends SuperClass {
}


/**
 * Esta anotación indica que una marca de automóvil está prohibida.
 * Gracias a @Documented, aparecerá en el Javadoc de las clases que la usen.
 */
@Documented
@Retention(RetentionPolicy.RUNTIME)
@interface ProhibidaMarca {
    String value(); // La marca prohibida
}
...
class Automovil extends Transporte implements Avanzar, Frenar{
    ...
    public Automovil(String marca, String modelo, String color, double precio) {
        if ("BMW".equalsIgnoreCase(marca)) {
            throw new IllegalArgumentException("No se permite la marca BMW");
        }
        this.marca = marca;
        this.modelo = modelo;
        this.color = color;
    ...
    /**
    * @deprecated
    * mostrarInfo() sustituyo este metodo debajo, razon: esnseña toda la informacion
    */
   @Deprecated
...
public class Practica82 {
    ...
    public static void main(String[] args) {
        CustomAnnotation annotation = SubClass.class.getAnnotation(CustomAnnotation.class);
        ...
        autos.add(new Automovil("NoBMW", "Serie 3", "Gris", 600000));
